...
const OrderItem = ({ item, index, consumer }) => {
    ...
    return (
        <>
            <TouchableOpacity onPress={() => { setModalView(true); fetchAllocations(); }}>
                <Animated.View
                    style={[
                        styles.orderCard,
                        { opacity: fadeAnim, transform: [{ translateY }] },
                    ...
                    <View style={styles.modalBackground}>
                        <View style={styles.reportContainer}>
                            ...
                            <View style={styles.section}>
                                ...
                                <View style={styles.row}>
                                    <Text style={styles.label}>Net Rate (₹/kg)</Text>
                                    <Text style={styles.value}>
                                        ₹ {item.net_rate ?? 'N/A'}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.section}>
                                ...
                                {loadingAllocations ? (
                                    ...
                                    <Text style={styles.notes}>No allocation data found.</Text>
                                ) : (
                                    allocations.map((alloc, i) => (
                                        <View key={i} style={[styles.row, { flexDirection: 'column', alignItems: 'flex-start', marginBottom: 8 }]}>
                                            <Text style={styles.label}>
                                                {alloc.Stock?.Stock_Name || 'Stock'}
                                            </Text>
                                            <Text style={styles.value}>
                                                Qty: {alloc.Quantity_Allocated} kg
                                            </Text>
                                        </View>
                                    ))
                                )}
